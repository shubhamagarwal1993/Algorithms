...
int edit_distance(string str1, string str2, int str1_len, int str2_len)
{
	...
	return 1 + min( min(edit_distance(str1, str2, str1_len, str2_len-1), edit_distance(str1, str2, str1_len-1, str2_len)), edit_distance(str1, str2, str1_len-1, str2_len-1));
}
