/*
 * A* is a path-finding, and graph traversal algorithm that is used to approximate shortest path in real-life situations like maps, and games where there can be many hindrances.
 *
